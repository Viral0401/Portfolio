  ...
  return (
    <div className="bg-secondary border-border flex flex-col justify-between rounded-[14px] border p-5">
      <div className="flex items-start justify-between gap-2">
        ...
        <figure className="flex justify-end items-center overflow-hidden">
          <Image
            src={cover}
            width={250}
            height={100}
            alt="Project Cover"
            className={`${
              title === "FitZen" || title === "Medex"
                ? "h-auto max-h-[180px] w-[250px] object-contain py-2"
                : "h-[100px] w-[250px] object-cover"
            } rounded-md shadow-[0px_1.66px_3.74px_-1.25px_#18274B1F]`}
          />
        </figure>
      </div>
